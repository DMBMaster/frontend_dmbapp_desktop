...
import { UseTransactionActivity } from './hook/useTransactionActivity'

export const TransactionActivityPage = () => {
  const isOnline = useNetworkStore((state) => state.isOnline)

  const { data, loading, pageParams, setPageParams, table, permissions } = UseTransactionActivity(
    {}
  )
  ...
  return permissions.read ? (
    <Box>
      ...
      <Breadcrumb
        ...
        items={[{ to: '/', title: 'Home' }, { title: 'Other' }, { title: 'Transaction Activity' }]}
      />
