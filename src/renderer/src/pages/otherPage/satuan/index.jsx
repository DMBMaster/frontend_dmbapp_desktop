...
export const UnitPage = () => {
  ...
  return permissions.read ? (
    <Box>
      ...
      <Breadcrumb
        title="Data Satuan"
        items={[{ to: '/', title: 'Home' }, { title: 'Produk' }, { title: 'Data Satuan' }]}
      />
      ...
      <Stack direction="row" spacing={2} mb={3} justifyContent="space-between" alignItems="center">
        ...
        {permissions.create && (
          <Button
            ...
            onClick={() => setOpenDialog((prev) => ({ ...prev, update: false, add: true }))}
          >
            Tambah Data
          </Button>
        )}
      ...
      <Dialog
        ...
        maxWidth="sm"
      >
        <DialogTitle>{openDialog.update ? 'Edit Kategori' : 'Tambah Kategori'}</DialogTitle>
        <DialogContent>
