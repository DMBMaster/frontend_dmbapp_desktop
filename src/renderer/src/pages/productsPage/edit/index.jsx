              ...
              <Card>
                <CardContent>
                  ...
                  <Autocomplete
                    value={
                      categories.find(
                        (category) => parseInt(category.id) === parseInt(formData.category_id)
                      ) || null
                    }
                  ...
                  <Autocomplete
                    value={units.find((unit) => unit.id === formData.satuan_id) || null}
                    onChange={(event, newValue) => {
                      setFormData((prev) => ({ ...prev, satuan_id: newValue ? newValue.id : '' }))
                    }}
                    options={units}
                  ...
                  >
                    ...
                    {formData.images ? (
                      typeof formData.images === 'string' ? (
                        ...
                        <img
                          src={URL.createObjectURL(formData.images)} // Create a URL for the uploaded image
                          alt="Uploaded preview"
                          style={{
                            width: '100%',
                            maxWidth: '300px',
                    ...
                    {formData.touched?.images && formData.errors?.images && (
                      <div style={{ color: 'red' }}>{formData.errors.images}</div>
                    )}
                  </Box>
                </CardContent>
              </Card>
