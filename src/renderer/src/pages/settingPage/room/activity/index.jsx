...
import { UseRoomActivity } from './hook/useRoomActivity'

export const RoomActivityPage = () => {
  const isOnline = useNetworkStore((state) => state.isOnline)

  const { data, loading, pageParams, setPageParams, table, permissions } = UseRoomActivity({})
