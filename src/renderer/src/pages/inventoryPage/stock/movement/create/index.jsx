...
import { UseCreateStockMovement } from './hook/useCreateStockMovement'
...
export const CreateStockMovementPage = () => {
            ...
            <Box bgcolor={'white'} p={3}>
                ...
                <Grid size={{ xs: 12, sm: 5 }}>
                  <Box textAlign="left">
                    ...
                    <Autocomplete
                      ...
                      value={
                        listOutlets && formData.new_outlet_id
                          ? listOutlets.find((outlet) => outlet.guid === formData.new_outlet_id) ||
                            null
                          : null
                      }
                      onChange={(event, newValue) => {
                        console.log(newValue, 'Selected Outlet')
                        setFormData((prevData) => ({
                          ...prevData,
                          new_outlet_id: newValue ? newValue.guid : ''
                        }))
                      }}
                      renderInput={(params) => (
                        <CustomTextField {...params} placeholder="Pilih Outlet" fullWidth />
                      )}
                      renderOption={(props, option) => {
                        const isOptionDisabled =
                          localStorage.getItem('outletGuid') === option.outlet_id
                        return (
                          <li
                            {...props}
              ...
              >
                ...
                <Button
                  ...
                  variant="contained"
                  color="primary"
                  disabled={formData.new_outlet_id === '' || formData.date === ''}
